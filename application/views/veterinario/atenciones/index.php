    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <a href="<?= base_url('veterinario/atenciones_urgencias') ?>" class="text-decoration-none">
            ...
            <div class="col-md-12 mb-3">
                <a href="<?= base_url('veterinario/atenciones/sedaciones') ?>" class="text-decoration-none">
            ...
            <div class="col-md-12 mb-3">
                <a href="<?= base_url('veterinario/atenciones_eutanasias') ?>" class="text-decoration-none">
            ...
            <div class="col-md-12 mb-3">
                <a href="<?= base_url('veterinario/atenciones/citas') ?>" class="text-decoration-none">
            ...
            <div class="col-md-12 mb-3">
                <a href="<?= base_url('veterinario/atenciones/cirugias') ?>" class="text-decoration-none">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tipoAtencion').change(function() {
                ...
                $.ajax({
                    url: '<?= base_url('veterinario/obtener_atenciones') ?>',
                    type: 'POST',
                    data: { tipo: tipo },
            ...
            function actualizarContadores() {
                $.ajax({
                    url: '<?= base_url('veterinario/obtener_contadores') ?>',
                    type: 'GET',
                    success: function(response) {
